package lin.xi.chun.concurrency.thread.cp_pattern.asynchronous.producer_consumer;
...
/**
 * 后记：
 * 自解：利用消息队列这个中间属性解耦了【结果等待者】和【结果生产者】之间的同步关系，生产者和消费者之间不需要去控制同步，
 * 但是生产者和消息队列、消息队列和消费者可以各自维护同步关系
 * */
